        ...
        <div className="mt-10 flex flex-col gap-x-6 gap-y-8 ">
            <div className="">
                ...
                <div className="mt-2">
                    ...
                    {invalid.nickName &&
                        <p className='bg-danger text-white px-3 mt-2 rounded-md'>{invalid.nickName}</p>
                    }
                 </div>
            </div>
            ...
            <div className="">
                ...
                <div className="mt-2">
                    ...
                    {invalid.breed &&
                        <p className='bg-danger text-white px-3 mt-2 rounded-md'>{invalid.breed}</p>
                    }
                </div>
            </div>
            ...
            <div className="">
                ...
                {invalid.detail &&
                    <p className='bg-danger text-white px-3 mt-2 rounded-md'>{invalid.detail}</p>
                }
            </div>
            <div className="">
                    <label
            ...
            <div className="">
                ...
                <div className="mt-2 flex justify-center rounded-lg border border-dashed border-gray-900/25 sm:px-6 py-10">
                    <div className="text-center">
                        ...
                        <div className="mt-4 flex flex-col lg:flex-row text-sm justify-center leading-6 text-gray-600">
                            ...
                            <input id="image" name="image" type="file" accept='image/png image/jpg image/jpeg' onChange={e => handlePetFile(e)} className="sr-only"/>
                            </label>
                        </div>
                ...
                {invalid.image &&
                    <p className='bg-danger text-white px-3 mt-2 rounded-md'>{invalid.image}</p>
                }
            </div>
