...
import { getPetData } from '../../services/getPetData';

export const PetCard = ({ image, btnText, description, title, btnHref, petId })=> {
    const petData = getPetData(petId)
    console.log(petData)
	return (
		<div className="mb-10 overflow-hidden rounded-lg bg-slate-50 shadow-1 duration-300 hover:shadow-3 dark:bg-dark-2 dark:shadow-card dark:hover:shadow-3">
