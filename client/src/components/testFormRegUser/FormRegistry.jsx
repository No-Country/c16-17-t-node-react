...
const FormRegistry = () => {
  const { invalid, handleSubmit } = useFormRegister();

	return (
		<div>
			<form
				onSubmit={handleSubmit}
				className="container bg-primary flex flex-col items-center justify-center gap-5 border-2 mx-auto p-5 h-auto"
			>
          ...
          {invalid.email &&
            <p className='bg-danger text-white px-3 mt-2 rounded-md'>{invalid.email}</p>
          }
				</div>
				<div className="px-4 md:w-1/2">
					<label className="mb-[10px] block text-base font-medium text-black">
          ...
          {invalid.password &&
            <p className='bg-danger text-white px-3 mt-2 rounded-md'>{invalid.password}</p>
          }
				</div>
				<div className="px-4 md:w-1/2">
					<label className="mb-[10px] block text-base font-medium text-black">
          ...
          {invalid.repeatPassword &&
            <p className='bg-danger text-white px-3 mt-2 rounded-md'>{invalid.repeatPassword}</p>
          }
				</div>
